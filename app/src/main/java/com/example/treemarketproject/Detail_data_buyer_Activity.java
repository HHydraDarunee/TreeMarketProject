...
public class Detail_data_buyer_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_data_buyer);
        getIncomingIntent();
        ...
        button_back_data_seller.setOnClickListener(view -> {
            Intent in = new Intent(Detail_data_buyer_Activity.this, Read_data_Activity.class);
            startActivity(in);
        });
    ...
    private void setImage(String image_drawable_id, String shopName,String productName,String productNum,String shopAddress) {
        ...
        TextView shop_name = findViewById(R.id.textView__shopname_detail_product_buyer);
            shop_name.setText(shopName);

        TextView product_name = findViewById(R.id.textView_name_detail_product_buyer);
            product_name.setText(productName);

        TextView product_num = findViewById(R.id.textView_num_detail_product_buyer);
            product_num.setText(productNum);

        TextView shop_address = findViewById(R.id.textView_address_detail_product_buyer);
